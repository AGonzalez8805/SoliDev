            ...
            <?php $currentPage = $_GET['action'] ?? 'home';?>
                ...
                <div class="ms-auto">
                    <?php if (isset($_SESSION['admin_id'])): ?>
                        ...
                        <a href="/auth&action=logout" class="mr-5 hover:text-stone-200">Déconnexion</a>
                    <?php elseif (isset($_SESSION['user_id'])): ?>
                        <a href="#" class="mr-5 hover:text-stone-200">Mon compte</a>
                        <a href="/auth&action=logout" class="mr-5 hover:text-stone-200">Déconnexion</a>
                    <?php else: ?>
                        <a href="/auth&action=registration" class="btn btn-outline-light btn-registration me-3">Inscription</a>
                        <a href="/auth&action=login" class="btn btn-outline-light btn-login me-3">Connexion</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
